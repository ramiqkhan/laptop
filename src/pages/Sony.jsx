...
const Sony = () => {
  ...
  useEffect(() => {
    const fetchSonyProducts = async () => {
      ...
      try {
        ...
        const sonyOnly = data.filter(p => p.brand?.toUpperCase() === 'SONY');
        setProducts(sonyOnly);
      } catch (err) {
  ...
  const renderImage = (product, index = 0) => {
    ...
    return 'https://placehold.co/400x300?text=Sony+Laptop';
  };
  ...
  return (
    <div className="bg-[#F8F9FA] min-h-screen font-sans pb-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        {selectedProduct ? (
          /* --- Sony DETAIL VIEW (Laptop Layout) --- */
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            >
              <ArrowLeft size={16} strokeWidth={3} /> Back to Sony Collection
            </button>
                ...
                <div className="flex flex-col">
                  <div className="mb-4">
                    <span className="px-4 py-1.5 bg-[#0F172A] text-white text-[10px] font-black rounded-full uppercase tracking-[0.2em] italic">
                      Sony {selectedProduct.category} Series
                    </span>
                  </div>
            ...
            <main className="flex-1">
              <div className="bg-white rounded-[2rem] border border-[#E6E6E6] p-6 mb-10 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-sm">
                <p className="text-[#0F172A] font-black text-[10px] uppercase tracking-widest italic">
                  Inventory: {filteredAndSorted.length} Sony Units Available
                </p>
              ...
              {filteredAndSorted.length === 0 ? (
                <div className="text-center py-24 bg-white rounded-[3rem] border border-[#E6E6E6]">
                  <p className="text-gray-300 font-black uppercase tracking-[0.2em] italic">No Match Found in Sony Repository</p>
                </div>
              ) : (
