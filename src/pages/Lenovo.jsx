...
const Lenovo = () => {
  ...
  // Lenovo Specific Products Data
  const allProducts = useMemo(() => [
    { id: 501, name: "Lenovo Legion 5 Pro Gen 8", price: 385000, rating: 5, reviews: 210, img: lap1, ram: "16GB", gpu: "RTX 4060" },
    { id: 502, name: "Lenovo ThinkPad X1 Carbon Gen 11", price: 415000, rating: 5, reviews: 95, img: lap2, ram: "16GB", gpu: "Integrated" },
    { id: 503, name: "Lenovo Yoga 7i Convertible", price: 235000, rating: 4, reviews: 140, img: lap1, ram: "16GB", gpu: "Integrated" },
    { id: 504, name: "Lenovo IdeaPad Gaming 3", price: 185000, rating: 4, reviews: 310, img: lap2, ram: "8GB", gpu: "RTX 3050" },
    { id: 505, name: "Lenovo LOQ 15 Gaming", price: 225000, rating: 4, reviews: 85, img: lap1, ram: "16GB", gpu: "RTX 4050" },
    { id: 506, name: "Lenovo V15 Business Laptop", price: 95000, rating: 3, reviews: 120, img: lap2, ram: "8GB", gpu: "Integrated" },
  ...
  const categories = [
    ...
    { title: "GPU", options: ["Integrated", "RTX 3050", "RTX 4050", "RTX 4060"] },
  ];
    ...
    <div className="bg-[#F8F9FA] min-h-screen font-sans pb-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl md:text-3xl font-bold text-black uppercase tracking-tight">Lenovo Laptops</h1>
          <nav className="hidden sm:block text-xs md:text-sm text-gray-500">
            ...
            <span className="text-gray-800 font-medium">Lenovo</span>
          </nav>
        </div>
          ...
          <main className="flex-1">
            ...
            {filteredAndSortedProducts.length === 0 ? (
                <div className="text-center py-20 bg-white rounded-2xl border border-[#E6E6E6] shadow-sm">
                  <p className="text-gray-500 text-lg">No Lenovo laptops match your filters.</p>
                </div>
            ) : (
