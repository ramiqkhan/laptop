...
const HP = () => {
  ...
  // HP Specific Products Data
  const allProducts = useMemo(() => [
    { id: 101, name: "HP Victus 15 Gaming", price: 185000, rating: 5, reviews: 450, img: lap1, ram: "16GB", gpu: "RTX 3060" },
    { id: 102, name: "HP Pavilion x360 Convertible", price: 145000, rating: 4, reviews: 120, img: lap2, ram: "8GB", gpu: "Integrated" },
    { id: 103, name: "HP Omen 16 High Performance", price: 325000, rating: 5, reviews: 89, img: lap1, ram: "16GB", gpu: "RTX 4060" },
    { id: 104, name: "HP Envy 13 Ultra Thin", price: 210000, rating: 4, reviews: 310, img: lap2, ram: "16GB", gpu: "Integrated" },
    { id: 105, name: "HP EliteBook 840 G9", price: 160000, rating: 5, reviews: 520, img: lap1, ram: "8GB", gpu: "Integrated" },
    { id: 106, name: "HP ProBook 450 Business", price: 135000, rating: 3, reviews: 95, img: lap2, ram: "8GB", gpu: "Integrated" },
    ...Array.from({ length: 6 }, (_, i) => ({
        id: i + 107,
        name: `HP Laptop 15s Series ${i + 107}`,
        price: 95000 + (i * 9500),
        rating: 4,
        reviews: 30 + i, 
        img: i % 2 === 0 ? lap1 : lap2,
  ...
  const categories = [
    ...
    { title: "GPU", options: ["Integrated", "RTX 3060", "RTX 4060", "RTX 4070"] },
  ];
    ...
    <div className="bg-[#F8F9FA] min-h-screen font-sans pb-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl md:text-3xl font-bold text-black">HP Laptops</h1>
          ...
          <main className="flex-1">
            ...
            {filteredAndSortedProducts.length === 0 ? (
               <div className="text-center py-20 bg-white rounded-2xl border border-[#E6E6E6] shadow-sm">
                 <p className="text-gray-500 text-lg">No HP laptops match your filters.</p>
               </div>
            ) : (
                  ...
                  <div key={product.id} className="bg-white rounded-2xl border border-[#E6E6E6] shadow-sm p-5 hover:shadow-xl transition-all duration-300 flex flex-col relative group">
                    ...
                    <div className="mt-auto flex items-center justify-between gap-2">
                      ...
                      <Link 
                        ...
                        className="px-4 py-2.5 bg-gradient-to-r from-[#F4C430] to-[#d6a11e] text-slate-800 text-[10px] sm:text-[11px] font-bold rounded-xl border-b-[3px] border-[#b8962d] uppercase whitespace-nowrap hover:brightness-110 active:scale-95 transition-all shadow-sm flex items-center justify-center"
                      >
                        View Details
                      </Link>
                    </div>
