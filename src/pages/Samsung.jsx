...
const Samsung = () => {
  ...
  // Samsung Specific Products Data
  const allProducts = useMemo(() => [
    { id: 601, name: "Samsung Galaxy Book4 Ultra", price: 565000, rating: 5, reviews: 42, img: lap1, ram: "32GB", display: "AMOLED" },
    { id: 602, name: "Samsung Galaxy Book3 Pro 360", price: 345000, rating: 5, reviews: 115, img: lap2, ram: "16GB", display: "AMOLED" },
    { id: 603, name: "Samsung Galaxy Book2 Business", price: 175000, rating: 4, reviews: 85, img: lap1, ram: "16GB", display: "LED" },
    { id: 604, name: "Samsung Galaxy Book Go (LTE)", price: 85000, rating: 3, reviews: 210, img: lap2, ram: "8GB", display: "LED" },
    { id: 605, name: "Samsung Galaxy Book3 Pro 14\"", price: 295000, rating: 5, reviews: 65, img: lap1, ram: "16GB", display: "AMOLED" },
    { id: 606, name: "Samsung Galaxy Chromebook 2", price: 115000, rating: 4, reviews: 130, img: lap2, ram: "8GB", display: "QLED" },
    ...Array.from({ length: 4 }, (_, i) => ({
        id: i + 607,
        name: `Samsung Galaxy Book Elite ${i + 607}`,
  ...
  const filteredAndSortedProducts = useMemo(() => {
    let result = allProducts.filter(product => {
      ...
      if (selectedFilters.Display.length > 0 && !selectedFilters.Display.includes(product.display)) return false;
      return true;
    });
  ...
  const categories = [
    ...
    { title: "Display", options: ["AMOLED", "QLED", "LED"] },
  ];
    ...
    <div className="bg-[#F8F9FA] min-h-screen font-sans pb-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl md:text-3xl font-bold text-black uppercase tracking-tight">Samsung Laptops</h1>
          ...
          <main className="flex-1">
            ...
            {filteredAndSortedProducts.length === 0 ? (
                <div className="text-center py-20 bg-white rounded-2xl border border-[#E6E6E6] shadow-sm">
                  <p className="text-gray-500 text-lg">No Samsung laptops match your filters.</p>
                </div>
            ) : (
