...
const API_URL = `${BASE_URL}/api/workstations/all`;  // --- FIXED & SYNCED ADD TO CART ---
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl md:text-3xl font-bold text-black">
            {selectedProduct ? 'Product Details' : (new URLSearchParams(location.search).get('search') ? `Results for "${new URLSearchParams(location.search).get('search')}"` : 'Workstations')}
          </h1>
