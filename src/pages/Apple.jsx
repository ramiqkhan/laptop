...
const Apple = () => {
  ...
  // Apple Specific Products Data
  const allProducts = useMemo(() => [
    { id: 301, name: "MacBook Air 13-inch M2", price: 315000, rating: 5, reviews: 240, img: lap1, ram: "8GB", chipset: "M2" },
    { id: 302, name: "MacBook Pro 14-inch M3", price: 545000, rating: 5, reviews: 110, img: lap2, ram: "16GB", chipset: "M3" },
    { id: 303, name: "MacBook Pro 16-inch M3 Max", price: 980000, rating: 5, reviews: 35, img: lap1, ram: "32GB", chipset: "M3 Max" },
    { id: 304, name: "MacBook Air 15-inch M3", price: 385000, rating: 5, reviews: 150, img: lap2, ram: "16GB", chipset: "M3" },
    { id: 305, name: "MacBook Pro 14-inch M3 Pro", price: 620000, rating: 5, reviews: 85, img: lap1, ram: "18GB", chipset: "M3 Pro" },
    { id: 306, name: "MacBook Air 13-inch M1 (2020)", price: 215000, rating: 4, reviews: 890, img: lap2, ram: "8GB", chipset: "M1" },
  ...
  const filteredAndSortedProducts = useMemo(() => {
    let result = allProducts.filter(product => {
      ...
      if (selectedFilters.Chipset.length > 0 && !selectedFilters.Chipset.includes(product.chipset)) return false;
      return true;
    });
  ...
  const categories = [
    { title: "RAM", options: ["8GB", "16GB", "18GB", "32GB"] },
    { title: "Chipset", options: ["M1", "M2", "M3", "M3 Pro", "M3 Max"] },
  ];
    ...
    <div className="bg-[#F8F9FA] min-h-screen font-sans pb-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl md:text-3xl font-bold text-black">Apple MacBooks</h1>
          ...
          <main className="flex-1">
            ...
            {filteredAndSortedProducts.length === 0 ? (
               <div className="text-center py-20 bg-white rounded-2xl border border-[#E6E6E6] shadow-sm">
                 <p className="text-gray-500 text-lg">No MacBooks found matching these criteria.</p>
               </div>
            ) : (
