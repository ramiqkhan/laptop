...
const Dell = () => {
  ...
  // Dell Specific Products Data
  const allProducts = useMemo(() => [
    { id: 401, name: "Dell XPS 13 Plus 9320", price: 425000, rating: 5, reviews: 180, img: lap1, ram: "16GB", gpu: "Integrated" },
    { id: 402, name: "Dell G15 5530 Gaming", price: 215000, rating: 4, reviews: 320, img: lap2, ram: "16GB", gpu: "RTX 3060" },
    { id: 403, name: "Dell Alienware m16 R2", price: 585000, rating: 5, reviews: 45, img: lap1, ram: "32GB", gpu: "RTX 4070" },
    { id: 404, name: "Dell Inspiron 15 3520", price: 115000, rating: 4, reviews: 510, img: lap2, ram: "8GB", gpu: "Integrated" },
    { id: 405, name: "Dell Latitude 5440 Business", price: 195000, rating: 4, reviews: 85, img: lap1, ram: "16GB", gpu: "Integrated" },
    { id: 406, name: "Dell Vostro 3510", price: 105000, rating: 3, reviews: 140, img: lap2, ram: "8GB", gpu: "Integrated" },
  ...
  const categories = [
    ...
    { title: "GPU", options: ["Integrated", "RTX 3060", "RTX 3070", "RTX 4070"] },
  ];
    ...
    <div className="bg-[#F8F9FA] min-h-screen font-sans pb-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl md:text-3xl font-bold text-black">Dell Laptops</h1>
          <nav className="hidden sm:block text-xs md:text-sm text-gray-500">
            ...
            <span className="text-gray-800 font-medium">Dell</span>
          </nav>
        </div>
          ...
          <main className="flex-1">
            ...
            {filteredAndSortedProducts.length === 0 ? (
               <div className="text-center py-20 bg-white rounded-2xl border border-[#E6E6E6] shadow-sm">
                 <p className="text-gray-500 text-lg">No Dell laptops match your filters.</p>
               </div>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                {currentProducts.map((product) => (
                  <Link 
                    ...
                    key={product.id} 
                    className="bg-white rounded-2xl border border-[#E6E6E6] shadow-sm p-5 hover:shadow-xl transition-all duration-300 flex flex-col relative group cursor-pointer active:scale-[0.98]"
                  >
                    ...
                    {/* Product Name */}
                    <h3 className="text-lg font-black text-[#0F172A] mb-1 leading-tight h-14 overflow-hidden group-hover:text-[#d6a11e] transition-colors">
                      {product.name}
                    </h3>
                    ...
                    <div className="mt-auto flex items-center justify-between gap-2">
                      ...
                      <div className="px-4 py-2.5 bg-gradient-to-r from-[#F4C430] to-[#d6a11e] text-slate-800 text-[10px] sm:text-[11px] font-bold rounded-xl border-b-[3px] border-[#b8962d] uppercase whitespace-nowrap group-hover:brightness-110 transition-all shadow-sm">
                        View Details
                      </div>
                    </div>
                  </Link>
